...
sed -e "s/\${TELEGRAF_HOST}/$TELEGRAF_HOST/" \
    ...
    -e "s/\${NOKIA_2310_USER}/$NOKIA_2310_USER/" \
    -e "s/\${NOKIA_2310_PASSWORD}/$NOKIA_2310_PASSWORD/" \
    -e "s!\${NOKIA_2310_HOST}!$NOKIA_2310_HOST!" \
    -e "s/\${NOKIA_2310_GNMI_PORT}/$NOKIA_2310_GNMI_PORT/" \
